...
export function AiUpsell({ visit, currentSelections }: { visit: VisitWithVisitor, currentSelections?: string }) {
  const [behavior, setBehavior] = useState('');
  const [preferences, setPreferences] = useState(visit.mustHave || '');
